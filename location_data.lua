...
local provinces = {
    ...
    "西藏自治区", "宁夏回族自治区", "新疆维吾尔自治区", "北京市", "天津市", "上海市",
    "重庆市", "香港特别行政区", "澳门特别行政区"
}
...
local cities = {
    ...
    ["山西省"] = {
        "太原市", "大同市", "阳泉市", "长治市", "晋城市", "朔州市", "晋中市", "运城市", "忻州市",
        "临汾市", "吕梁市"
    },
    ["辽宁省"] = {
    ...
    ["广东省"] = {
        ...
        "肇庆市", "惠州市", "梅州市", "汕尾市", "河源市", "阳江市", "清远市", "东莞市", "中山市",
        "潮州市", "揭阳市", "云浮市"
    },
    ["海南省"] = {
        "海口市", "三亚市", "三沙市", "儋州市", "五指山市", "琼海市", "文昌市", "万宁市", "东方市",
        "定安县", "屯昌县", "澄迈县", "临高县", "白沙黎族自治县", "昌江黎族自治县", "乐东黎族自治县",
    ...
    ["台湾省"] = {
        ...
        "新竹县", "苗栗县", "彰化县", "南投县", "云林县", "嘉义县", "屏东县", "宜兰县", "花莲县",
        "台东县", "澎湖县"
    },
    ["内蒙古自治区"] = {
    ...
    ["新疆维吾尔自治区"] = {
        "乌鲁木齐市", "克拉玛依市", "吐鲁番市", "哈密市", "阿克苏地区", "喀什地区", "和田地区",
    ...
    ["天津市"] = {
        "和平区", "河东区", "河西区", "南开区", "河北区", "红桥区", "东丽区", "西青区", "津南区",
        "北辰区", "武清区", "宝坻区", "滨海新区", "宁河区", "静海区", "蓟州区"
    },
    ["上海市"] = {
    ...
    ["重庆市"] = {
        "万州区", "黔江区", "涪陵区", "渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区",
        "北碚区", "渝北区", "巴南区", "长寿区", "江津区", "合川区", "永川区", "南川区", "綦江区",
        "大足区", "璧山区", "铜梁区", "潼南区", "荣昌区", "开州区", "梁平区", "武隆区", "城口县",
        "丰都县", "垫江县", "忠县", "云阳县", "奉节县", "巫山县", "巫溪县", "石柱土家族自治县",
...
local districts = {
    ["河北省/唐山市"] = {"路北区", "路南区", "古冶区", "开平区", "丰南区", "丰润区", "曹妃甸区", "滦州市", "滦南县", "乐亭县", "迁西县", "玉田县", "遵化市", "迁安市"},
    -- 补充其他城市区县数据...
}

-- 国外数据
local countries = {"美国", "加拿大", "英国", "法国", "德国", "日本", "韩国", "澳大利亚"}
local timeZones = {"UTC-12", "UTC-11", "UTC-10", "UTC-9", "UTC-8", "UTC-7", "UTC-6", "UTC-5"}
